  ...
  renderer(Renderer(gfx))
{
  ...
  tri_buff[1] = Triangle(
    ...
    Vec2(0.0f, 0.0f),
    Vec2(0.0f, 0.0f));
  renderer.grid1920_1080p.PlaceAABBInCell(RectI(300, 200, 300, 400), 0, 1);
}
...
void Game::ComposeFrame()
{
  ...
  Shader shader(gfx);
  rasterizer.RasterizeCells(renderer.grid1920_1080p.cells, tri_buff, shader,
    renderer.grid1920_1080p.CELL_WIDTH, renderer.grid1920_1080p.CELL_HEIGHT,
    renderer.grid1920_1080p.WIDTH, renderer.grid1920_1080p.HEIGHT);
}